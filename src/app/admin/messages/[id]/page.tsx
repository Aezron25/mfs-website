...
export default function AdminChatPage() {
    ...
    const otherParticipantName = otherParticipantId ? convData?.participantNames[otherParticipantId] : 'Client';
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-theme(space.28))]">
